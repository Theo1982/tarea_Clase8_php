...
<html lang="en">
    ...
    <body>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name=`tipo de prenda` placeholder="Tipo de Prenda" value="<?php echo "$tipo_prenda"; ?>"> /dentro del value ponemos el dato que que trajimos del egistro para que ya aparezca el el imput y no volver aq escribirlo
            <label>Marca</label>
        ...
        if(array_key_exists('guardar_cambios',$_POST)){
            ...
            $tipo_prenda=$_POST['tipo de prenda'];
                    $marca=$_POST['marca'];
                    $talle=$_POST['talle'];
                    $precio=$_POST['precio'];
            ...
            // a) generar la consulta a realizar
             $consulta = "UPDATE ropa SET `tipo de prenda` WHERE id = $id?='$tipo_prenda', marca='$marca', talle='$talle', precio='$precio', imagen='$imagen'";
